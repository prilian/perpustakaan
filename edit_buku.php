...
$query = mysqli_query($link,"SELECT * FROM buku WHERE id='$id'");
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              ...
              <form action="proses_edit_buku.php" method="post" class="form-horizontal" id="quickForm">
              ...
              <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10 col-form-input">
                        <input type="text" name="namaBuku" class="form-control" id="namaBuku" placeholder="Nama Buku" value="<?php echo $data["nama"]; ?>" required>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10 col-form-input">
                    <input type="text" name="jenisBuku" class="form-control" id="jenisBuku" placeholder="Jenis Buku" value="<?php echo $data["jb"]; ?>" required>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="penerbit" class="col-sm-2 col-form-label">Penerbit</label>
                    <div class="col-sm-10 col-form-input">
                        <input type="text" name="penerbit" class="form-control" id="penerbit" placeholder="Penerbit" value="<?php echo $data["penerbit"]; ?>" required>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="tahunTerbit" class="col-sm-2 col-form-label">Tahun Terbit</label>
                    <div class="col-sm-10 col-form-input">
                        <input type="date" name="tahunTerbit" class="form-control" id="tahunTerbit" value="1990-01-01" value="<?php echo $data["tahun_terbit"]; ?>" required>
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->

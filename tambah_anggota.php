        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              ...
              <form action="simpan_anggota.php" method="post" class="form-horizontal" id="quickForm">
                <div class="card-body">
                  <div class="form-group row">
                    <label for="nomorAnggota" class="col-sm-2 col-form-label">Nomor Anggota</label>
                    <div class="col-sm-10 col-form-input">
                        <input type="text" name="nomorAnggota" class="form-control" id="nomorAnggota" placeholder="Nomor Anggota"minlength="5" required>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="namaAnggota" class="col-sm-2 col-form-label">Nama</label>
                    <div class="col-sm-10 col-form-input">
                        <input type="text" name="namaAnggota" class="form-control" id="namaAnggota" placeholder="Nama Anggota" required>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10 col-form-input">
                        <input type="date" name="tglLahir" class="form-control" id="tglLahir" value="1990-01-01" required>
                    </div>
                  </div>
                  <div class="form-group row">
